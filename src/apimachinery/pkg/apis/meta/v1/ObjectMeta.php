...
use k8s\apimachinery\pkg\apis\meta\v1\ManagedFieldsEntry;
use k8s\apimachinery\pkg\apis\meta\v1\OwnerReference;

/**
 * ObjectMeta is metadata that all persisted resources must have, which includes all objects users must create.
 */
class ObjectMeta extends \k8s\Resource
{
    /**
    ...
    /**
     * @var ManagedFieldsEntry[] $managedFields
    ...
    /**
     * @var OwnerReference[] $ownerReferences
