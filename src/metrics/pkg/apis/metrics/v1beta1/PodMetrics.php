...
use k8s\metrics\pkg\apis\metrics\v1beta1\ContainerMetrics;
 ...
 */
class PodMetrics extends \k8s\Resource
{
    /**
    ...
    /**
     * @var ContainerMetrics[] $containers
