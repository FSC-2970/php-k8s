...
use k8s\api\autoscaling\v2beta2\ContainerResourceMetricStatus;
use k8s\api\autoscaling\v2beta2\ExternalMetricStatus;
use k8s\api\autoscaling\v2beta2\ObjectMetricStatus;
use k8s\api\autoscaling\v2beta2\PodsMetricStatus;
use k8s\api\autoscaling\v2beta2\ResourceMetricStatus;
