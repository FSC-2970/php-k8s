...
use k8s\api\flowcontrol\v1beta1\LimitResponse;
 ...
 */
class LimitedPriorityLevelConfiguration extends \k8s\Resource
{
    /**
     * @var integer $assuredConcurrencyShares
     ...
     */
    public $assuredConcurrencyShares;
