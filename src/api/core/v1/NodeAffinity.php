...
use k8s\api\core\v1\PreferredSchedulingTerm;
use k8s\api\core\v1\NodeSelector;

/**
 * Node affinity is a group of node affinity scheduling rules.
 */
class NodeAffinity extends \k8s\Resource
{
    /**
     * @var PreferredSchedulingTerm[] $preferredDuringSchedulingIgnoredDuringExecution
    ...
    /**
     * @var NodeSelector $requiredDuringSchedulingIgnoredDuringExecution
