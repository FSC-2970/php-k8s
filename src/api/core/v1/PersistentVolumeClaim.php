...
use k8s\api\core\v1\PersistentVolumeClaimStatus;

/**
 * PersistentVolumeClaim is a user's request for and claim to a persistent volume
 */
class PersistentVolumeClaim extends \k8s\Resource
{
    /**
    ...
    /**
     * @var PersistentVolumeClaimStatus $status
    ...
    public function __construct($data)
    {
        ...
        if (isset($data['status'])) {
            $this->status = new PersistentVolumeClaimStatus($data['status']);
        }
    }
}
