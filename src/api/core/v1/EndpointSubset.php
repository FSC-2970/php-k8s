...
use k8s\api\core\v1\EndpointAddress;
use k8s\api\core\v1\EndpointPort;
 ...
 */
class EndpointSubset extends \k8s\Resource
{
    /**
     * @var EndpointAddress[] $addresses
     * IP addresses which offer the related ports that are marked as ready. These endpoints should be considered safe for load balancers and clients to utilize.
     */
    public $addresses;

    /**
     * @var EndpointAddress[] $notReadyAddresses
