...
use k8s\api\core\v1\ServicePort;
use k8s\api\core\v1\SessionAffinityConfig;

/**
 * ServiceSpec describes the attributes that a user creates on a service.
 */
class ServiceSpec extends \k8s\Resource
{
    /**
     * @var boolean $allocateLoadBalancerNodePorts
     * allocateLoadBalancerNodePorts defines if NodePorts will be automatically allocated for services with type LoadBalancer.  Default is "true". It may be set to "false" if the cluster load-balancer does not rely on NodePorts.  If the caller requests specific NodePorts (by specifying a value), those requests will be respected, regardless of this field. This field may only be set for services with type LoadBalancer and will be cleared if the type is changed to any other type. This field is beta-level and is only honored by servers that enable the ServiceLBNodePortControl feature.
     */
    public $allocateLoadBalancerNodePorts;

    /**
     * @var string $clusterIP
    ...
    /**
     * @var string $internalTrafficPolicy
     * InternalTrafficPolicy specifies if the cluster internal traffic should be routed to all endpoints or node-local endpoints only. "Cluster" routes internal traffic to a Service to all endpoints. "Local" routes traffic to node-local endpoints only, traffic is dropped if no node-local endpoints are ready. The default value is "Cluster".
     */
    public $internalTrafficPolicy;

    /**
     * @var string $ipFamilies
     ...
     */
    public $ipFamilyPolicy;

    /**
     * @var string $loadBalancerClass
     ...
     */
    public $publishNotReadyAddresses;
