...
use k8s\api\authorization\v1\SubjectAccessReviewSpec;
use k8s\api\authorization\v1\SubjectAccessReviewStatus;

/**
 * LocalSubjectAccessReview checks whether or not a user or group can perform an action in a given namespace. Having a namespace scoped resource makes it much easier to grant namespace scoped policy that includes permissions checking.
 */
class LocalSubjectAccessReview extends \k8s\Resource
{
    /**
    ...
    /**
     * @var SubjectAccessReviewSpec $spec
    ...
    public function __construct($data)
    {
        ...
        if (isset($data['spec'])) {
            $this->spec = new SubjectAccessReviewSpec($data['spec']);
        }
