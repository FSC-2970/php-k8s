 ...
 */
class PodDisruptionBudgetStatus extends \k8s\Resource
{
    /**
    ...
    /**
     * @var integer $currentHealthy required
     * current number of healthy pods
     */
    public $currentHealthy;

    /**
     * @var integer $desiredHealthy required
     * minimum desired number of healthy pods
     */
    public $desiredHealthy;

    /**
     * @var object $disruptedPods
    ...
    /**
     * @var integer $disruptionsAllowed required
     * Number of pod disruptions that are currently allowed.
     */
    public $disruptionsAllowed;

    /**
     * @var integer $expectedPods required
