 ...
 */
class JobSpec extends \k8s\Resource
{
    /**
    ...
    /**
     * @var integer $backoffLimit
     * Specifies the number of retries before marking this job failed. Defaults to 6
     */
    public $backoffLimit;

    /**
     * @var string $completionMode
    ...
    /**
     * @var integer $ttlSecondsAfterFinished
