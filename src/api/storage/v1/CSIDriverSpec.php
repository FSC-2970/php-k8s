...
use k8s\api\storage\v1\TokenRequest;

/**
 * CSIDriverSpec is the specification of a CSIDriver.
 */
class CSIDriverSpec extends \k8s\Resource
{
    /**
     * @var boolean $attachRequired
     ...
     */
    public $attachRequired;

    /**
     * @var string $fsGroupPolicy
     ...
     */
    public $fsGroupPolicy;

    /**
     * @var boolean $podInfoOnMount
     ...
     * This field is immutable.
     */
    public $podInfoOnMount;

    /**
     * @var boolean $requiresRepublish
     * RequiresRepublish indicates the CSI driver wants `NodePublishVolume` being periodically called to reflect any possible change in the mounted volume. This field defaults to false.
     * 
     * Note: After a successful initial NodePublishVolume call, subsequent calls to NodePublishVolume should only update the contents of the volume. New mount points will not be seen by a running container.
     */
    public $requiresRepublish;

    /**
     * @var boolean $storageCapacity
    ...
    /**
     * @var TokenRequest[] $tokenRequests
    ...
    /**
     * @var string $volumeLifecycleModes
