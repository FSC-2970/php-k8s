...
use k8s\api\storage\v1\VolumeNodeResources;

/**
 * CSINodeDriver holds information about the specification of one CSI driver installed on a node
 */
class CSINodeDriver extends \k8s\Resource
{
    /**
     * @var VolumeNodeResources $allocatable
