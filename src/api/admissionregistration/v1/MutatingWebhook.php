 ...
 */
class MutatingWebhook extends \k8s\Resource
{
    /**
    ...
    public function __construct($data)
    {
        ...
        $this->reinvocationPolicy = isset($data['reinvocationPolicy']) ? $data['reinvocationPolicy'] : null;
