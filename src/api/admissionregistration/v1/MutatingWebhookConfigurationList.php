...
use k8s\api\admissionregistration\v1\MutatingWebhookConfiguration;
use k8s\apimachinery\pkg\apis\meta\v1\ListMeta;

/**
 * MutatingWebhookConfigurationList is a list of MutatingWebhookConfiguration.
 */
class MutatingWebhookConfigurationList extends \k8s\Resource
{
    /**
    ...
    public function __construct($data)
    {
        ...
        $this->items = array_map(function ($a) {
            return new MutatingWebhookConfiguration($a);
