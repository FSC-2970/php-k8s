...
use k8s\api\admissionregistration\v1\ValidatingWebhookConfiguration;
use k8s\apimachinery\pkg\apis\meta\v1\ListMeta;

/**
 * ValidatingWebhookConfigurationList is a list of ValidatingWebhookConfiguration.
 */
class ValidatingWebhookConfigurationList extends \k8s\Resource
{
    /**
    ...
    public function __construct($data)
    {
        ...
        $this->items = array_map(function ($a) {
            return new ValidatingWebhookConfiguration($a);
